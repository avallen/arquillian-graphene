...
import org.jboss.arquillian.graphene.jquery.JQuerySearchContext;
...
public class ByJQuery extends By {
    ...
    private final JavascriptExecutor executor = GrapheneContext.getProxyForInterfaces(JavascriptExecutor.class);
    ...
    public ByJQuery(String jquerySelector) {
        this.jquerySelector = jquerySelector;//jquerySelector.replaceAll("\\\"", "\\\\\"");
    }
